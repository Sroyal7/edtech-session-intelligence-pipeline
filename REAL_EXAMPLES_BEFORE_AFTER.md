# EdTech Session Intelligence Pipeline – Real Before/After Examples

**Overview:** 10 real candidate profiles processed through the system. Shows how raw consultant notes transform into structured, high-intent discovery summaries ready for sales conversations.
...
IT Background - 3 yrs
did Btech - CS - 2022
Tasks - Devops Engineer
Current: Working in product company, team of 4
Tools: Github actions, Pipeline changes, Azure, configuration tool
Learning: Kubernetes, Terraform
Commute: 2 hours - the only challenge
Looking for Remote Jobs - more productive & efficient when not travelling
Current salary: 15 LPA (Hybrid)
Expected: 18-20 LPA based on experience & structured upskilling
Timeline: 5-6 months ideal, but can switch in 2 months (notice period)
3-5 yrs goal: Well-equipped Developer
Strength: Consistent best rating
Recently married - planning better education for kids
Husband: Civil Engineer
Can commit: 1-2 hours daily for upskilling
Sole decision maker
```
...
- **Career Goal:** Career growth + more exposure
- **Long-term Vision (3–5 yrs):** Well-equipped developer

**⏰ Timeline & Commitment**

- **Ideal Timeline:** 5–6 months
...
Currently exploring part-time job - can give 5 hours
Tasks she handles: Accounting & Bookkeeping, Tally, MS Office
Certifications: Excel, Tally
Worked with Cooperative Firms, CA Firms
...
18 months - health issue (career break)
Education: Engineer in CS - 2007
Previously: 50 LPA
Part time - Training AI Models
...
- **Work Type:** Seeking flexible, part-time engagement (not full-time return)
...
MBA - Sales & Marketing
Experience: Leads funneling, sales closing, web & mobile apps
Break: Left 1 month ago (boredom)
Enjoys: Marketing more than sales
Skills: Sales & Marketing
Income: 50–60K previously, expecting same
Availability: 6–8 hours daily
Currently: Managing through savings
...
- **Current Financial Status:** Managing through savings
- **Financial Independence:** Doesn't want parental support
...
Previously Flipkart - 3 yrs
Current: Senior Technician - Software & Hardware Troubleshooting
Reason for change: Hectic work, remote job converting to office mandate
Personal: Have kids, want work-life balance
Education: MCA (2018)
...
Career break: ~1 year (leave of absence from 2025)
Recent experience: BPO Billing (2016), Vendor Management & Settlement (2025)
Role: Account Executive & Vendor Management
Education: B.Com (2015), CIA – Computer Application (2015–16)
Tools: SAP, Oracle, accounting processes
Current: Upskilling via YouTube (Accounts Payable)
Child: 5 years old
Husband: Merchant Navy (often away)
Needs: Remote role (child responsibility)
Salary expectation: ~35K/month (previous 4.5 LPA)
Timeline: 2–3 months
Availability: 9-hour shift
...
Responsibilities: Software testing, automation (Playwright)
Work preference: Remote only
Status: Actively looking, upskilling & networking on LinkedIn
Interview status: In progress with 7 companies
Current offers: 11–13 LPA range
Looking for: AI-domain companies (where they use AI)
Current salary: 9.4 LPA
Expectations: Higher based on experience, certifications, projects
Certifications: Generative AI, Playwright (certified last month)
Education: MTech CS (2017)
Long-term (3–5 yrs): Leading a Team as QA Specialist
...
**Expected Output After Deep Probing**

- **Why AI:** Career differentiation, emerging domain, future-proof skillset
...
Medical history: Open heart surgery, Cardiac health issue
Personal: Divorcee
Current goal: Start comfortably in teaching field
Current challenge: Lack of guidance, lack of clarity on genuine opportunities
Skills: Patience, resilience, dedication, accountable
Technical: Coding (C, SQL), wants to shift toward AI
Support: Elder brother is Software Engineer (US), Father is Assistant Engineer
Target roles: AI-related, Python upskilling
Salary expectation: 20K (immediate joiner)
Timeline: Join immediately
Availability: 8–9 hrs job + 3–4 hrs upskilling
Current status: Dependent on parents (2 months research & upskilling ongoing)
Long-term (3–5 yrs): Upgrade skills → Managerial role
...
- **Location:** Kolkata (worked in Bangalore)
- **Education:** BSc (2018), B.Ed
...
- **Learning Goal:** Python + AI-related skills
- **Family Support:** Brother (US software engineer) available as mentor
- **Self-Directed:** 2 months research & upskilling ongoing
...
- **Conversion:** High – will commit 100% if path is clear + immediate start possible
...
Experience: 4+ yrs
Last role: Byju's (Sales & Business Development)
Then: HR roles (Recruitment, Payroll, Employee Engagement, Policy Formulation across IT & Non-IT)
Marketing exposure: Social media marketing, digital marketing
Current status: Upskilling in marketing (1-month self-paced course)
Education: MBA – Marketing & HR (2020)
Personal: Recently married (cannot relocate)
Career feeling: Stuck, outdated, underutilized
Goal: Performance marketing role → freelancing (3–5 yrs)
Timeline: Job by next month or max 2–3 months (delay affects confidence)
Availability: Upskilling 2 hrs/day, Part-time 3–4 hrs, Full-time 8–10 hrs
Constraints: Remote mandatory, cannot relocate (husband in Bhubaneswar)
Skills: Excel (listed)
Salary: Starting expectation 20K
Open to: Internship also
...
- **Skills:** Lead funneling, closing (implied)

**HR (Multiple companies)**
- Recruitment
- Payroll
- Employee Engagement
- Policy Formulation
- **Scope:** IT & Non-IT hiring
...
- Outdated
- Underutilized
- *(Likely driven by career anxiety, not clarity)*

**Career Urgency**

- **Timeline:** Job within 1–3 months (**URGENT**)
...
**Constraint Acknowledgment:** "Remote in Bhubaneswar limits you. There are good remote performance marketing roles, but you'll be competing with remote talent globally at ₹20K. Let's talk about whether ₹20K is actually sustainable, or we need a different structure."

**Expected Outcome If Converted**

- **Conversion:** Moderate-to-high – will commit if path is clear, but may second-guess after 1–2 months if growth isn't visible
...
| Profile | Type | Intent | Urgency | Risk | Conversion Angle |
|---------|------|--------|---------|------|-----------------|
| **New Delhi Logistics** | Career restart | Moderate | High (15–20 days) | Medical constraint | Medical-aware onboarding |
| **Hyderabad DevOps** | Growth-focused | HIGH | Medium (5–6 months) | None | Structured upskilling roadmap |
| **Kerala Accounting** | Stable explorer | LOW | Low | Lacks motivation | Income trigger needed |
| **Ahmedabad Engineer** | Flexible restart | Moderate | Medium (1 month) | Health recovery | Part-time AI training fit |
| **Punjab MBA** | Direction-lost | Low-Moderate | Low | Boredom fatigue | Purpose + clarity |
| **Bangalore Technician** | Work-life reset | HIGH | Medium | Family commitment | Remote + balance offer |
| **Haldwani Accounting** | Restart momentum | HIGH | HIGH (2–3 months) | Child care need | Remote accounting role |
| **MP QA Engineer** | Growth-ready | HIGH | Medium | Lacks 3-yr roadmap | FOMO activation |
| **Kolkata Changer** | Emotional restart | HIGH | HIGH (immediate) | Health + instability | Guidance + path clarity |
| **Bhubaneswar Marketer** | Anxiety-driven | Moderate | HIGH (1–3 months) | No specialization | Confidence rebuilding |
